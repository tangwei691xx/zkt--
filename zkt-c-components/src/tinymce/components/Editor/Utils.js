 ...
 *
 */
import {defaultConfig} from './EditorPropTypes'
import {zhcnLanguage} from '../zh_CN'
var validEvents = [
  'onActivate',
  'onAddUndo',
  'onBeforeAddUndo',
...
export var bindModelHandlers = function (ctx, editor) {
  var modelEvents = ctx.$props.modelEvents ? ctx.$props.modelEvents : defaultConfig.modelEvents
  ...
  editor.on(normalizedEvents, function () {
...
export var addLanguage = function (tinymce) {
  tinymce.addI18n('zh_CN', zhcnLanguage)
}